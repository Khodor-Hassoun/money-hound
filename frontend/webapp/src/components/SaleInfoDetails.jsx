    ...
    return (
        <div className="flex flex-col">
            ...
            <div className="flex flex-col py-2">
                ...
                <input type="number" id="date" name="tax" ref={vatRef} max={100} defaultValue={0} onChange={() => { paymentChange() }} className="border-black border-solid border rounded py-1 px-1"></input>
            </div>
            <div className="flex flex-col py-2">
